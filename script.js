...
function openWhatsAppChat() {
    const phoneNumber = "919792635131"; // Your WhatsApp number without '+' and spaces
    const message = "Hello! I would like to inquire about your AC & Fridge repair services."; // Default message
...
app.post("/contact", (req, res) => {
  ...
  db.query(sql, [name, email, message], (err, result) => {
    if (err) {
      ...
      sendWhatsAppMessage("+971502702634", name, email, message); // Client ka WhatsApp number
